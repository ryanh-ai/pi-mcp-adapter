...
| `scriptMode` | Register the MCP-only `mcpScript` plain-JavaScript tool (default: `false`). Set to `true` only for trusted code; enabling it prints a security warning. |
